...
import (
	_ "github.com/qimingzihaonanya1/wails/v2/internal/goversion" // Add Compile-Time version check for minimum go version
	"github.com/qimingzihaonanya1/wails/v2/pkg/application"
